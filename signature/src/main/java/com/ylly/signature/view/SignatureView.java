package com.ylly.signature.view;
...
import com.ylly.signature.R;
import com.ylly.signature.glide.SignFileOutputStream;
import com.ylly.signature.view.point.DrawPoint;
import com.ylly.signature.view.point.PointUtil;
import com.ylly.signature.view.point.TimedPoint;
...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int maxWidth = a.getDimensionPixelSize(R.styleable.SignatureView_paintMaxWidth, 16);
        int minWidth = a.getDimensionPixelSize(R.styleable.SignatureView_paintMinWidth, 8);
        int paintColor = a.getColor(R.styleable.SignatureView_paintColor, Color.BLACK);
     ...
     * 设置画笔宽度
     *
     * @param mMinWidth 画笔最小宽度
     * @param mMaxWidth 画笔最大宽度
     */
